...
ActiveRecord::Schema[7.1].define(version: 2023_10_16_130755) do
  ...
  create_table "record_items", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["category_id"], name: "index_record_items_on_category_id"
  ...
  add_foreign_key "record_items", "categories"
